...
*****TABLE A.16, MODEL 1 (FIGURE A.12; BOTTOM LEFT-HAND PANEL): PARTICIPATORY INCLINATION INTERACTION MODELS (JAUNARY)*******

estsimp regress supportstormers01 phq9 misperceptionssum12 anypolactive phq9_anypolactive dem rep ind libcon interest black white asian hispanic income_r edu_r  age socialmediaelecnewssum10 el_conf trumpsupporter if male==1 [pw=weight_nat]
...
*****TABLE A.16, MODEL 2 (FIGURE A.12; TOP LEFT-HAND PANEL): CONSPIRACY BELIEFS INTERACTION MODELS (JANUARY)*******

estsimp regress supportstormers01 phq9 misperceptionssum12 phq9_fn12 anypolactive  dem rep ind libcon interest black white asian hispanic income_r edu_r age  socialmediaelecnewssum10 el_conf trumpsupporter if male==1 [pw=weight_nat]
...
****TABLE A.16, MODEL 3 (FIGURE A.13; LEFT-HAND PANEL): SUPPORT CAPITOL RIOT (JANUARY PANEL)***

estsimp regress supportstormers01 phq9 anypolactive misperceptionssum12 phq9_anypolactive phq9_fn12 phq9_fn12_anypolactive dem rep ind libcon interest black white asian hispanic income_r edu_r age socialmediaelecnewssum10 el_conf trumpsupporter if male==1 [pw=weight_nat]
...
***sequence=phq9-anypolactive-fn12 (SO, DEPRESSION, THEN PARTICIPATORY INCLINATION, THEN CONSPIRACY BELIEFS, SUCH THAT, FOR INSTANCE, HILOHI = HIGH DEPRESSION, LOW PARTICIPATORY INCLINATION, HIGH CONSPIRACY BELIEFS)***
...
*****TABLE A.16, MODEL 4 (FIGURE A.14; TOP-LEFT-HAND PANEL): CONSPIRACY BELIEFS INTERACTION MODELS*******

estsimp ologit violence051 phq9 misperceptionssum12 phq9_fn anypolactive  dem rep ind libcon interest black white asian hispanic income_r edu_r age el_conf trumpsupporter if male==1 [pw=weight_nat]
...
*****TABLE A.16, MODEL 5 (FIGURE A.14; BOTTOM LEFT-HAND PANEL): PARTICIPATORY INCLINATION INTERACTION MODELS*******

estsimp ologit violence051 phq9 misperceptionssum12 anypolactive phq9_anypolactive dem rep ind libcon interest black white asian hispanic income_r edu_r  age el_conf trumpsupporter if male==1 [pw=weight_nat]
...
****TABLE A.16, MODEL 6 (FIGURE A.15; LEFT-HAND PANEL): HYPOTHETICAL ELECTION VIOLENCE (NOVEMBER)***

estsimp ologit violence051  phq9 anypolactive misperceptionssum12 phq9_anypolactive phq9_fn phq9_fn_anypolactive dem rep ind libcon interest black white asian hispanic income_r edu_r age  el_conf trumpsupporter if male==1 [pw=weight_nat]

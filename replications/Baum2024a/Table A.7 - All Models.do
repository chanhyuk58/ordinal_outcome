...
*****TABLE A.7, MODEL 1 (FIGURE 5; TOP-RIGHT-HAND PANEL):CONSPIRACY BELIEFS INTERACTION MODELS*******

estsimp ologit violence051 phq9 misperceptionssum12 phq9_fn anypolactive   libcon interest black white asian hispanic income_r edu_r age el_conf male dem rep ind if trumpsupporter==1 [pw=weight_nat]
...
*****TABLE A.7, MODEL 2 (FIGURE 5; BOTTOM RIGHT-HAND PANEL):PARTICIPATORY INCLINATION INTERACTION MODELS*******

estsimp ologit violence051 phq9 misperceptionssum12 anypolactive phq9_anypolactive  libcon interest black white asian hispanic income_r edu_r  age el_conf dem rep ind male if trumpsupporter==1  [pw=weight_nat]
...
****TABLE A.7, MODEL 3 (FIGURE 6; RIGHT-HAND PANEL):HYPOTHETICAL ELECTION VIOLENCE (NOVEMBER)***

estsimp ologit violence051  phq9 anypolactive misperceptionssum12 phq9_anypolactive phq9_fn phq9_fn_anypolactive libcon interest black white asian hispanic income_r edu_r male age  el_conf dem rep ind if trumpsupporter==1 [pw=weight_nat]


setx libcon 4.0 interest 3.34 black .12 white .65 asian .06 hispanic .14 income_r 4.01 age 46.6 edu_r 2.99 el_conf 2.79 male .47 dem .39 rep .30 ind .27 

...
*****TABLE A.12, MODEL 1 (FIGURE A.4: BOTTOM RIGHT-HAND PANEL): PARTICIPATORY INCLINATION INTERACTION MODELS*******

estsimp regress supportstormers01 phq9 misperceptionssum12 anypolactive phq9_anypolactive  libcon interest black white asian hispanic income_r edu_r  age socialmediaelecnewssum10 el_conf trumpsupporter male if rep==1  [pw=weight_nat]

setx interest 3.29 black .12 white .63 asian  .06 hispanic .16 income_r 3.92 socialmediaelecnewssum10 .47 el_conf  2.84 libcon 4.01 age  47.92 edu_r 4.37 interest 3.29 male .48 trumpsupporter .34 misperceptionssum12 .19
...
*********SUPPORT CAPITOL RIOT DV***************

*****TABLE A.12, MODEL 2 (FIGURE A.4; TOP RIGHT-HAND PANEL): CONSPIRACY BELIEFS INTERACTION MODELS*******

estsimp regress supportstormers01 phq9 misperceptionssum12 phq9_fn12 anypolactive   libcon interest black white asian hispanic income_r edu_r age  socialmediaelecnewssum10 el_conf male trumpsupporter if rep==1 [pw=weight_nat]

setx interest 3.29 black .12 white .63 asian  .06 hispanic .16 income_r 3.92 socialmediaelecnewssum10 .47 el_conf  2.84 libcon 4.01 age  47.92 edu_r 4.37 interest 3.29 male .48 trumpsupporter .34 anypolactive .27
...
****TABLE A.12, MODEL 3 (FIGURE A.5; RIGHT-HAND PANL): SUPPORT CAPITOL RIOT DV (JANUARY)***

estsimp regress supportstormers01 phq9 anypolactive misperceptionssum12 phq9_anypolactive phq9_fn12 phq9_fn12_anypolactive libcon interest black white asian hispanic income_r edu_r male age socialmediaelecnewssum10 el_conf trumpsupporter if rep==1 [pw=weight_nat]

setx interest 3.29 black .12 white .63 asian .06 hispanic .16 income_r 3.92 socialmediaelecnewssum10 .47 el_conf  2.84 libcon 4.01 age  47.92 edu_r  3.29 interest 3.29 male .48 trumpsupporter .34
...
************HYPOTHETICAL ELECTION VIOLENCE (JANUARY) DV*************


*****TABLE A.12, MODEL 4 (FIGURE A.6; TOP-RIGHT PANEL): CONSPIRACY BELIEFS INTERACTION MODELS*******

estsimp ologit violence051 phq9 misperceptionssum12 phq9_fn12 anypolactive   libcon interest black white asian hispanic income_r edu_r age  socialmediaelecnewssum10 el_conf male trumpsupporter if rep==1 [pw=weight_nat]
...
*****TABLE A.12, MODEL 5 (FIGURE A.6; BOTTOM-RIGHT PANEL): PARTICIPATORY INCLINATION INTERACTION MODELS*******

estsimp ologit violence051 phq9 misperceptionssum12 anypolactive phq9_anypolactive  libcon interest black white asian hispanic income_r edu_r  age socialmediaelecnewssum10 el_conf trumpsupporter male if rep==1  [pw=weight_nat]
...
****TABLE A.12, MODEL 6 (FIGURE A.7; RIGHT-HAND PANEL): HYPOTHETICAL ELECTION VIOLENCE (JANUARY) DV***

estsimp ologit violence051 phq9 anypolactive misperceptionssum12 phq9_anypolactive phq9_fn12 phq9_fn12_anypolactive libcon interest black white asian hispanic income_r edu_r male age socialmediaelecnewssum10 el_conf trumpsupporter if rep==1 [pw=weight_nat]

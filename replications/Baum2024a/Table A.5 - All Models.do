...
*****TABLE A.5, MODEL 1 (FIGURE 3; TOP LEFT-HAND PANEL): CONSPIRACY BELIEFS INTERACTION MODELS*******

***NOTE: sequence is phq9 (depression) - fn12 (conspiracy beliefs); so, for example, "lohi" = lo depression, high conspiracy beliefs***

estsimp ologit violence051 phq9 misperceptionssum12 phq9_fn anypolactive   libcon interest black white asian hispanic income_r edu_r age el_conf male trumpsupporter if dem==1 [pw=weight_nat]
...
*****TABLE A.5, MODEL 2 (FIGURE 3; BOTTOM LEFT-HAND PANEL): PARTICIPATORY INCLINATION INTERACTION MODELS*******

estsimp ologit violence051 phq9 misperceptionssum12 anypolactive phq9_anypolactive  libcon interest black white asian hispanic income_r edu_r  age el_conf trumpsupporter male if dem==1  [pw=weight_nat]
...
****TABLE A.5, MODEL 3 (FIGURE 4; LEFT-HAND PANEL): HYPOTHETICAL ELECTION VIOLENCE (NOVEMBER) DV***

estsimp ologit violence051  phq9 anypolactive misperceptionssum12 phq9_anypolactive phq9_fn phq9_fn_anypolactive libcon interest black white asian hispanic income_r edu_r male age  el_conf trumpsupporter if dem==1 [pw=weight_nat]

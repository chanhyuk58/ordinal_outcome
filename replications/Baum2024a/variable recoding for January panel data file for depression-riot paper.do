...
***DOWNLOAD THE JANUARY PANEL DATA FILE (FOR REPLICATION) FROM DATAVERSE AND SET UP THE WORKING DIRECTORY WHERE IT WILL BE STORED. KEEP ALL THE DATA IN THIS DIRECTORY.

***TO RUN REMOVE THE "*" BEFORE "CD" AND INSERT THE NAME OF THE DIRECTORY WITH THE DATA.

*cd "..."

use "January Panel Data File (for replication).dta",clear
...
****SUPPORT CAPITOL RIOT****
***note: variable label in do file is "supportstormers01"; in tables and in text, the variable name is "Support Capitol Riot"***
gen capitolstormerstherm01=therm2_15/100
gen capsup01=(cap_sup-1)/4
gen supportstormers01=(capitolstormerstherm01+capsup01)/2

***HYPOTHETICAL ELECTION VIOLENCE (JANUARY)***
***note: variable label in do file is "violence051"; in tables and in text, the variable name is "HYPOTHETICAL ELECTION VIOLENCE (JANUARY)"***
...
***note: variable label in do files is "socialmediaelecnewssum10" and variable name in tables and text is "Facebook Election News"***
gen socialmediaelecnewssum10=pol_news2_1
recode socialmediaelecnewssum10 .=0
...
gen misperceptionssum12=(hydroxy+facemaskcausecovid+binladenalive+ballotsindumpsters+bidenprofitedfamily+olderpeople+chinabioweapon+bats+curewithheld+fluvacriskscovid+natlemergency+novaccine)/12
...
****INDEPENDENT VARIABLES THAT DO NOT REQUIRE RECODING***
...
gen phq9_fn12=phq9*misperceptionssum12
gen phq9_anypolactive=phq9*anypolactive
gen phq9_fn12_anypolactive=phq9*anypolactive*misperceptionssum12
...
gen phq9low_fn12=phq9low*misperceptionssum12
gen phq9med_fn12=phq9med*misperceptionssum12
gen phq9hi_fn12=phq9hi*misperceptionssum12
gen phq9med_anypolactive=phq9med*anypolactive
gen phq9hi_anypolactive=phq9hi*anypolactive
gen phq9low_anypolactive_fn12=phq9low*misperceptionssum12*anypolactive
gen phq9med_anypolactive_fn12=phq9med*misperceptionssum12*anypolactive
gen phq9hi_anypolactive_fn12=phq9hi*misperceptionssum12*anypolactive

***SAVING REOCDED DATA FOR ANALYSES
save "January Panel Data File (for replication)_recoded.dta", replace

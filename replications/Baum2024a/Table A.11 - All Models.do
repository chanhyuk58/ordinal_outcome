...
*****TABLE A.11, MODEL 1 (FIGURE A.4; BOTTOM LEFT-HAND PANEL): PARTICIPATORY INCLINATION INTERACTION MODELS*******

estsimp regress supportstormers01 phq9 misperceptionssum12 anypolactive phq9_anypolactive  libcon interest black white asian hispanic income_r edu_r  age socialmediaelecnewssum10 el_conf trumpsupporter male if dem==1  [pw=weight_nat]
...
*****TABLE A.11, MODEL 2 (FIGURE A.4; TOP LEFT-HAND PANEL): CONSPIRACY BELIEFS INTERACTION MODELS*******

estsimp regress supportstormers01 phq9 misperceptionssum12 phq9_fn12 anypolactive   libcon interest black white asian hispanic income_r edu_r age  socialmediaelecnewssum10 el_conf male trumpsupporter if dem==1 [pw=weight_nat]
...
****TABLE A.11, MODEL 3 (FIGURE A.5; LEFT-HAND PANEL): SUPPORT CAPITOL RIOT DV (JANUARY)***

estsimp regress supportstormers01 phq9 anypolactive misperceptionssum12 phq9_anypolactive phq9_fn12 phq9_fn12_anypolactive libcon interest black white asian hispanic income_r edu_r male age socialmediaelecnewssum10 el_conf trumpsupporter if dem==1 [pw=weight_nat]
...
************HYPOTHETICAL ELECTION VIOLENCE (JANAURY) DV*************

*****TABLE A.11, MODEL 4 (FIGURE A.6; TOP-LEFT PANEL): CONSPIRACY BELIEFS INTERACTION MODELS*******

estsimp ologit violence051 phq9 misperceptionssum12 phq9_fn12 anypolactive   libcon interest black white asian hispanic income_r edu_r age  socialmediaelecnewssum10 el_conf male trumpsupporter if dem==1 [pw=weight_nat]
...
*****TABLE A.11, MODEL 5 (FIGURE A.6; BOTTOM LEFT PANEL): PARTICIPATORY INCLINATION INTERACTION MODELS*******

estsimp ologit violence051 phq9 misperceptionssum12 anypolactive phq9_anypolactive  libcon interest black white asian hispanic income_r edu_r  age socialmediaelecnewssum10 el_conf trumpsupporter male if dem==1  [pw=weight_nat]
...
****TABLE A.11, MODEL 6 (FIGURE A.7; LEFT-HAND PANEL): HYPOTHETICAL ELECTION VIOLENCE (JANUARY) DV***

estsimp ologit violence051 phq9 anypolactive misperceptionssum12 phq9_anypolactive phq9_fn12 phq9_fn12_anypolactive libcon interest black white asian hispanic income_r edu_r male age socialmediaelecnewssum10 el_conf trumpsupporter if dem==1 [pw=weight_nat]

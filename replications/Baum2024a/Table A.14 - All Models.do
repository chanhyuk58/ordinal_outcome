...
*****TABLE A.14, MODEL 1 (FIGURE A.8; BOTTOM LEFT-HAND PANEL): PARTICIPATORY INCLINATION INTERACTION MODELS*******

estsimp regress supportstormers01 phq9 misperceptionssum12 anypolactive phq9_anypolactive  libcon interest black white asian hispanic income_r edu_r  age socialmediaelecnewssum10 el_conf dem rep ind male if trumpsupporter==0  [pw=weight_nat]
...
*****TABLE A.14, MODEL 2 (FIGURE A.8; TOP LEFT-HAND PANEL): CONSPIRACY BELIEFS INTERACTION MODELS*******

estsimp regress supportstormers01 phq9 misperceptionssum12 phq9_fn12 anypolactive   libcon interest black white asian hispanic income_r edu_r age  socialmediaelecnewssum10 el_conf male dem rep ind if trumpsupporter==0 [pw=weight_nat]
...
****TABLE A.14, MODEL 3 (FIGURE A.9; LEFT-HAND PANEL): SUPPORT CAPITOL RIOT***

estsimp regress supportstormers01 phq9 anypolactive misperceptionssum12 phq9_anypolactive phq9_fn12 phq9_fn12_anypolactive libcon interest black white asian hispanic income_r edu_r male age socialmediaelecnewssum10 el_conf dem rep ind if trumpsupporter==0 [pw=weight_nat]
...
*****TABLE A.14, MODEL 4 (FIGURE A.10; TOP LEGT-HAND PANEL): CONSPIRACY BELIEFS INTERACTION MODELS*******

estsimp ologit violence051 phq9 misperceptionssum12 phq9_fn12 anypolactive   libcon interest black white asian hispanic income_r edu_r age  socialmediaelecnewssum10 el_conf male dem rep ind if trumpsupporter==0 [pw=weight_nat]
...
*****TABLE A.14, MODEL 5 (FIGURE A.10; BOTTOM LEFT-HAND PANEL): PARTICIPATORY INCLINATION INTERACTION MODELS*******

estsimp ologit violence051 phq9 misperceptionssum12 anypolactive phq9_anypolactive  libcon interest black white asian hispanic income_r edu_r  age socialmediaelecnewssum10 el_conf dem rep ind male if trumpsupporter==0  [pw=weight_nat]
...
****TABLE A.14, MODEL 6 (FIGURE A.11; LEFT-HAND PANEL): HYPOTHETICAL ELECTION VIOLENCE (JANUARY PANEL)***

estsimp ologit violence051 phq9 anypolactive misperceptionssum12 phq9_anypolactive phq9_fn12 phq9_fn12_anypolactive libcon interest black white asian hispanic income_r edu_r male age socialmediaelecnewssum10 el_conf dem rep ind if trumpsupporter==0 [pw=weight_nat]
